# -*- coding: utf-8 -*-
"""Copy of Audio_Exercise02_Week04_session19_student_exercise:Folder splitting.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1iilQhtikMFak_543bYYyvHiTs6OhhwWf
...
CSV_PATH = "/content/drive/MyDrive/AIClub_AP_Gorrumuchu_Vamsi/Mosquito project/dataset folder/mosquito_feature_extracted.csv"
...
SAVE_FOLDER = "/content/drive/MyDrive/AIClub_AP_Gorrumuchu_Vamsi/Mosquito project/dataset folder"
TRAIN_CSV = "mosquito_features_train.csv"
TEST_CSV = "mosquito_features_test.csv"

# save the train csv
df_train.to_csv(os.path.join(SAVE_FOLDER, "mosquito_features_train.csv"), index = False)
# save the test csv
df_test.to_csv(os.path.join(SAVE_FOLDER, "mosquito_features_test.csv"), index = False)